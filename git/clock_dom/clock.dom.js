	...
	for (var i = 1; i <= 12; i++) {
		...
		function updateTime() {
			...
			if (currTime.getHours() < 12) {
				...
				hour = (currTime.getHours() - 12);
			}

			secondArrow.style.transform = "rotate(" + second * angeTime + "deg)"; minuteArrow.style.transform = "rotate(" + (minute + 15) * angeTime + "deg)"; hourArrow.style.transform = "rotate(" + (hour + 3) * angeHour + "deg)";
